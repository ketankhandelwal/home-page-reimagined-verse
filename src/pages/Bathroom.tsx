      ...
      <div className="relative h-[400px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-white text-center animate-fade-in">
            ...
            <p className="text-2xl text-gray-200 font-light">Premium quality bathroom fixtures and accessories</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-20 flex-grow relative">
        ...
        <div className="text-center mb-16 animate-fade-in relative z-10">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Explore our premium range of bathroom fixtures and accessories designed to enhance your space with style and functionality
          </p>
        </div>
