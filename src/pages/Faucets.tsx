...
const Faucets = () => {
  ...
  const handleNextSlide = () => {
    setCurrentSlide((prev) => (prev === faucetSets.length - 1 ? 0 : prev + 1));
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 flex flex-col">
      ...
      <div className="relative h-[600px] overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('src/files/images/faucets/image.png')` }} />
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-white text-center animate-fade-in">
            ...
            <p className="text-2xl text-gray-200 font-light">Premium quality faucets for your bathroom and kitchen</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-20 flex-grow relative">
        ...
        <div className="text-center mb-16 animate-fade-in relative z-10">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Explore our premium range of faucets designed to enhance your bathroom and kitchen with style and functionality
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
          {faucetSets[currentSlide].map((item, index) => (
            <div 
              key={index}
      ...
      <div className="container mx-auto px-4 py-16 relative">
        <div className="flex justify-center items-center space-x-8">
          ...
          <div 
            ...
            className={`w-16 h-16 ${currentSlide === faucetSets.length - 1 ? 'bg-gradient-to-r from-yellow-400 to-orange-400' : 'bg-white'} rounded-full shadow-lg flex items-center justify-center transform hover:scale-110 transition-transform duration-300 cursor-pointer`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className={`h-8 w-8 ${currentSlide === faucetSets.length - 1 ? 'text-white' : 'text-gray-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          </div>
        </div>
